...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'S3LogRecord.object_size'
        db.alter_column('tamarin_s3logrecord', 'object_size', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'S3LogRecord.object_size'
        raise RuntimeError("Cannot reverse this migration. 'S3LogRecord.object_size' and its values cannot be restored.")
