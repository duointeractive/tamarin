...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'S3LogRecord.http_version'
        db.add_column('tamarin_s3logrecord', 'http_version', self.gf('django.db.models.fields.CharField')(default='HTTP/1.1', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'S3LogRecord.http_version'
        db.delete_column('tamarin_s3logrecord', 'http_version')
