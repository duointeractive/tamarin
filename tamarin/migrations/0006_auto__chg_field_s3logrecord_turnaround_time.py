...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tamarin_s3logrecord', 'turnaround_time', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'S3LogRecord.turnaround_time'
        raise RuntimeError("Cannot reverse this migration. 'S3LogRecord.turnaround_time' and its values cannot be restored.")
