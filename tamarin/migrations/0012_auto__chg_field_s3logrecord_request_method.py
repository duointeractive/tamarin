...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'S3LogRecord.request_method'
        db.alter_column('tamarin_s3logrecord', 'request_method', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'S3LogRecord.request_method'
        raise RuntimeError("Cannot reverse this migration. 'S3LogRecord.request_method' and its values cannot be restored.")
