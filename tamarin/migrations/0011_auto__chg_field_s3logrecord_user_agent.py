...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'S3LogRecord.user_agent'
        db.alter_column('tamarin_s3logrecord', 'user_agent', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'S3LogRecord.user_agent'
        raise RuntimeError("Cannot reverse this migration. 'S3LogRecord.user_agent' and its values cannot be restored.")
